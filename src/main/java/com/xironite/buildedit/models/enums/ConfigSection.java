...
public enum ConfigSection {
    ...
    ACTION_BLACKLIST("messages.blacklist.target"),
    ACTION_BLACKLIST_DELIMITER("messages.blacklist.delimiter"),
    ACTION_BLACKLIST_SEPARATOR("messages.blacklist.separator"),
